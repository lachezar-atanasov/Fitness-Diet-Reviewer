...
namespace Fitness_Diet_Reviewer.Migrations
{
    ...
    [Migration("20240225160339_OnDeleteCascadeDailyMealRowsFitnessDiets")]
    partial class OnDeleteCascadeDailyMealRowsFitnessDiets
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Fitness_Diet_Reviewer.Models.RequestedFood", b =>
                {
                    ...
                    b.Property<string>("UsernameRequest")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
